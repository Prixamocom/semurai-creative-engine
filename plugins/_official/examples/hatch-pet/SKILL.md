...
> **Semurai Creative integration.** This is the unmodified Codex `hatch-pet` skill,
> vendored under `skills/hatch-pet/` so any Semurai Creative agent can run it. After
