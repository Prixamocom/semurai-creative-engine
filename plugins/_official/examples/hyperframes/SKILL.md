...
## Semurai Creative integration (load-bearing for this surface)

When this skill runs inside Semurai Creative (i.e. `$OD_PROJECT_DIR` is set), the
...
do NOT write the composition HTML from scratch. Use Semurai Creative's
...
#    already registered). Semurai Creative writes these files itself; it does
