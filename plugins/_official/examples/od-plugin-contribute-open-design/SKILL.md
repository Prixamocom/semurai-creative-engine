...
description: Open a pull request adding a local Semurai Creative plugin to the Semurai Creative community catalog using gh CLI.
triggers:
  - contribute plugin
  - semurai creative pr
  - github pull request
...
# Contribute Plugin to Semurai Creative

Use this workflow when the active project contains a copied plugin folder and the user wants to propose it for the Semurai Creative community catalog.
...
Keep the pull request focused. Do not modify unrelated Semurai Creative files unless a manifest validation issue requires a tiny supporting change.
