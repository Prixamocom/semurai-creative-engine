...
description: |
  Semurai Creative's investor pitch book: market map, moat, unit economics, and the ask — analyst-grade and diligence-ready. Built as a decision-grade fundraising pitch deck for growth-equity investors.
en_description: |
  Semurai Creative's investor pitch book: market map, moat, unit economics, and the ask — analyst-grade and diligence-ready. Built as a decision-grade fundraising pitch deck for growth-equity investors.
zh_description: |
...
repackaged as a Semurai Creative `deck` skill.
...
Follow Semurai Creative's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to Semurai Creative financial skills
...
original adaptation for Semurai Creative.
