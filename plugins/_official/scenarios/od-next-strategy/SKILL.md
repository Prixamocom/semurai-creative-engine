...
When Semurai Creative supplies a validated V2 binding, load the assets in this order:
...
are staged by Semurai Creative into the project directory (`.od-frames/`) for the
...
runtime facts exist unless Semurai Creative supplied them.
