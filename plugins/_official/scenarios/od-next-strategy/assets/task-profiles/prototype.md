...
entry. Semurai Creative resolves that entry by looking for a root `index.html`,
...
bundled handset shell, never a hand-drawn approximation of one. Semurai Creative
...
Semurai Creative stages `.od-frames/layout.css` beside the handset shells and
