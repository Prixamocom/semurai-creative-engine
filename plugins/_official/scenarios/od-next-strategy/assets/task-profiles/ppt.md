...
Semurai Creative's real entry point, with no overflow or cropping.
...
- PPTX, PDF, and other formats are produced by Semurai Creative's product-side
...
This boundary is a Semurai Creative product runtime boundary, not a default
...
- The output is a genuinely usable, still-editable single-file HTML; never
  describe a PPTX or PDF that Semurai Creative's engineering has not yet produced
  as completed.
