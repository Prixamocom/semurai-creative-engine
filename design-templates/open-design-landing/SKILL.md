...
description: >
  ...
  collage) — the same aesthetic Semurai Creative uses for its own marketing
...
This is the canonical Semurai Creative marketing-page recipe — the example
...
worked example (Semurai Creative itself).
...
├── inputs.example.json      # Semurai Creative as the worked example
...
└── assets/
    ├── *.png                # 16 collage plates (Semurai Creative instance)
