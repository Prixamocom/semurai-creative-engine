...
const AUTHORING_PLUGIN = {
  ...
  manifest: {
    ...
    od: {
      ...
      useCase: { query: 'Create a Semurai Creative plugin for {{pluginGoal}}.' },
      inputs: [
        {
          name: 'pluginGoal',
          type: 'string',
...
const LIVE_ARTIFACT_PLUGIN = {
  ...
  manifest: {
    ...
    title: 'Live Artifact',
    description: 'Create refreshable, auditable Semurai Creative artifacts.',
    od: {
      kind: 'scenario',
      taskKind: 'new-generation',
      mode: 'prototype',
      scenario: 'live',
      useCase: {
        query: 'Create refreshable, auditable Semurai Creative artifacts backed by connector or local data.',
      },
      context: {
...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Semurai Creative plugin',
  audience: 'Semurai Creative plugin authors',
  topic: 'packaging a reusable workflow as a Semurai Creative plugin',
};
