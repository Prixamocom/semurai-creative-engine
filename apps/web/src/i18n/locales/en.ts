...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Semurai Creative Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrError.authMessage': 'Your Semurai Creative Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Semurai Creative Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Semurai Creative Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Semurai Creative Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.signInRequired.amr': 'Semurai Creative is not signed in',
  ...
  'chat.runError.title.runtimeConfig': "Semurai Creative error",
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Semurai Creative to the latest version, which ships a compatible runtime.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Semurai Creative — switch to a different version and retry.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker Semurai Creative needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  ...
  'settings.welcomeTitle': 'Welcome to Semurai Creative',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Semurai Creative will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Semurai Creative reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the Semurai Creative hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Semurai Creative',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Semurai Creative',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Semurai Creative Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Semurai Creative daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Semurai Creative.',
  ...
  'settings.amrAccountStatus': 'Semurai Creative Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Semurai Creative as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Semurai Creative team',
  'settings.privacyConsentKicker': 'Help us improve Semurai Creative',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Semurai Creative performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Semurai Creative starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Semurai Creative could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Semurai Creative to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Semurai Creative is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Semurai Creative as context.',
  'settings.mcpRunningNote': 'Keep Semurai Creative running. Restart your coding agent after setup.',
  ...
  'entry.discordAriaWithOnline': 'Join the Semurai Creative Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow Semurai Creative on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Semurai Creative on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use Semurai Creative Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss Semurai Creative Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Semurai Creative plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Semurai Creative Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Semurai Creative project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Semurai Creative Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Semurai Creative workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Semurai Creative and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Semurai Creative',
  'pluginCard.contributeTitle': 'Contribute plugin to Semurai Creative with a pull request',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Semurai Creative from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Semurai Creative is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Semurai Creative everywhere',
  'useEverywhere.modalTitle': 'Use Semurai Creative everywhere',
  'useEverywhere.modalSubtitle': 'Drop Semurai Creative into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Semurai Creative works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Semurai Creative is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Semurai Creative as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Semurai Creative at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Semurai Creative from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Semurai Creative as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Semurai Creative ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Semurai Creative tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Semurai Creative app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Semurai Creative running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Semurai Creative extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Semurai Creative and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Semurai Creative extras)',
  ...
  'entry.githubStarAria': 'Star Semurai Creative on GitHub',
  ...
  'newproj.locationDefault': 'Semurai Creative projects',
  ...
  'avatar.amrConsole': 'Semurai Creative Cloud',
  ...
  'socialShare.openDesignSection': 'Share Semurai Creative',
  'socialShare.openDesignTitle': 'Semurai Creative on GitHub',
  'socialShare.openDesignText': 'Semurai Creative is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Semurai Creative: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Semurai Creative: {title}\n{url}\nSemurai Creative repo: {repo}',
  ...
  'brandEnrichment.body': "Semurai Creative will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Semurai Creative to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Semurai Creative to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Semurai Creative is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Semurai Creative? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Semurai Creative on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Semurai Creative on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Semurai Creative on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.shareMenuPublishViaOd': 'QUICK SHARE · SEMURAI CREATIVE',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to Semurai Creative Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to Semurai Creative',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Semurai Creative — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Semurai Creative — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Semurai Creative project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Semurai Creative should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Semurai Creative {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Semurai Creative is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Semurai Creative could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Semurai Creative is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Semurai Creative',
  'updater.quitFailedBody': 'The installer is open, but Semurai Creative could not quit. Quit Semurai Creative before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Semurai Creative will close and open the installer.',
  'updater.readyVersion': 'Semurai Creative {version} is ready. Semurai Creative will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Semurai Creative will close and open the installer.',
  'updater.reinstallReadyVersion': 'Semurai Creative {version} requires a full reinstall. Semurai Creative will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'Semurai Creative {version} is here',
  ...
  'dsManager.createBody': 'Teach Semurai Creative your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Semurai Creative follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Semurai Creative your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Semurai Creative turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in Semurai Creative. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Semurai Creative — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Semurai Creative. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve Semurai Creative",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend Semurai Creative to a colleague or friend?",
  ...
  'chat.designSystemStatus.description': 'Semurai Creative is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use Semurai Creative's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Semurai Creative built for design work. Output is noticeably better in layout, structure, and completeness.",
