...
export const GUIDE_SECTIONS: GuideSection[] = [
  {
    id: 'overview',
    tabLabel: 'Overview',
    heading: 'Semurai Creative works wherever your agent works',
    intro:
      'Semurai Creative is more than a window — it is a local privileged daemon ' +
    ...
    bullets: [
      ...
      'MCP server — wires Semurai Creative as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
      'HTTP API — `http://127.0.0.1:7456/api/*` REST + SSE endpoints; the same surface the web UI uses.',
      'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Semurai Creative at all.',
    ...
    snippets: [
      ...
      },
      {
        ...
        body:
          ...
          '# Then start Semurai Creative in the shell you normally use for dev:\n' +
          'pnpm tools-dev',
      },
    ],
    footer:
  ...
  },
  {
    id: 'cli',
    tabLabel: 'CLI · od',
    heading: 'Drive Semurai Creative from any shell',
    intro:
  ...
  },
  {
    id: 'mcp',
    tabLabel: 'MCP server',
    heading: 'Expose Semurai Creative as an MCP server to any coding agent',
    intro:
      'Semurai Creative ships with a Model Context Protocol server (`od mcp`) ' +
      'that lets any MCP-capable client — Cursor, Claude Code, Antigravity, ' +
      'VS Code Copilot Chat, openclaw, hermes — discover Semurai Creative tools ' +
    ...
    footer:
      'In the Semurai Creative app, open Settings → Integrations to copy a ' +
  ...
  },
  {
    ...
    heading: 'Drop-in Skills for any agent — even without Semurai Creative running',
    intro:
      'A Skill is a directory with a Claude-compatible `SKILL.md` ' +
      '(YAML front-matter + body). Semurai Creative extends the format with the ' +
      '`od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so ' +
      'the same artifact can be used both inside Semurai Creative and by a vanilla ' +
    ...
    snippets: [
      {
        label: 'Minimal SKILL.md (Claude-compatible front matter + Semurai Creative extras)',
        language: 'yaml',
        body:
          '---\n' +
      ...
      },
      {
        ...
        body:
          ...
          '# Shell 1: start Semurai Creative after ingesting.\n' +
          'pnpm tools-dev\n' +
