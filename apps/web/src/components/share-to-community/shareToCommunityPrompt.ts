...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as a Semurai Creative plugin so I can install it into My plugins and open a PR to the Semurai Creative community catalog.',
  '',
