...
const COMMUNITY_PAGE_PRESETS: ProjectPagePreset[] = [
  {
    ...
    category: 'prototype',
    title: pageText('Semurai Creative Landing', 'Semurai Creative 落地页', 'Semurai Creative 落地頁'),
...
<body>
  <main>
    <section class="hero">
      <div>
        <div class="eyebrow">Semurai Creative</div>
        <h1>${safeTitle}</h1>
        <p>${safeBody}</p>
      </div>
  ...
  <div class="deck-shell">
    <main class="deck-stage" id="deck-stage">
      <section class="slide active cover" data-screen-label="01 Cover">
        <div class="kicker">Semurai Creative deck</div>
        <h1>${safeTitle}</h1>
...
<body>
  <article>
    <div class="meta">Semurai Creative document</div>
    <h1>${safeTitle}</h1>
    <p>${safeBody}</p>
    <h2>Purpose</h2>
