export const studioEditorCopy = {
  pl: { expired: 'Sesja wygasła. Otwórz Studio ponownie z Semurai. Niezapisany projekt możesz pobrać jako HTML.', duplicateSlide: 'Duplikuj slajd', removeSlide: 'Usuń slajd', moveUp: 'Przesuń wcześniej', moveDown: 'Przesuń dalej', back: 'Wróć do czatu', saved: 'Zapisano', unsaved: 'Niezapisane zmiany', save: 'Zapisz', preview: 'Podgląd', source: 'Źródło', edit: 'Edytuj',
  ...
  en: { expired: 'Session expired. Reopen Studio from Semurai. You can download unsaved work as HTML.', duplicateSlide: 'Duplicate slide', removeSlide: 'Delete slide', moveUp: 'Move earlier', moveDown: 'Move later', back: 'Back to chat', saved: 'Saved', unsaved: 'Unsaved changes', save: 'Save', preview: 'Preview', source: 'Source', edit: 'Edit',
