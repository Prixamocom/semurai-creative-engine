...
function buildDesignSystemCopySourceContext(input: {
  ...
  return [
    ...
    '',
    'This design-system workspace was created from an existing Semurai Creative project. Treat the copied project files as the primary source evidence for the generated design system.',
    '',
    '## Source project',
    '',
    ...
    '- Generate a reusable Semurai Creative design-system package in this same project: DESIGN.md, README.md, SKILL.md, colors_and_type.css, context/provenance, focused preview cards, preserved assets/build/fonts when available, and ui_kits/app/.',
...
export function registerProjectRoutes(app: Express, ctx: RegisterProjectRoutesDeps) {
  ...
  app.post('/api/projects', async (req, res) => {
    try {
      ...
      const requestedAutomaticStrategyTaskProfile =
        ...
        || req.body?.automaticStrategyTaskProfile === 'canvas'
  ...
  app.post('/api/projects/:id/design-system-copy', async (req, res) => {
    ...
    try {
      ...
      const sourceNotes = `Created from Semurai Creative project "${sourceProject.name}" (${sourceProject.id}).`;
