...
function buildDesignManifest(entries, projectLabel) {
  ...
  return JSON.stringify({
    ...
    title: projectLabel || 'Semurai Creative project',
    entryFile,
    sourceFiles: {
      all: files,
      html: htmlFiles,
...
function buildDesignHandoff(entries, projectLabel) {
  ...
  return `# ${projectLabel || 'Semurai Creative project'} implementation handoff
...
- Keep generated product UI free of Semurai Creative chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Semurai Creative chrome in the production UI.
