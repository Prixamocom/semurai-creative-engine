...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Semurai Creative</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Semurai Creative">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Semurai Creative</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Semurai Creative.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Semurai Creative.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Semurai Creative.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Semurai Creative.';
        }
