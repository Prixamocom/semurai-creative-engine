...
Creates one normal Semurai Creative project artifact entry file through the local daemon.
When --project is omitted, the active Semurai Creative project is used.
