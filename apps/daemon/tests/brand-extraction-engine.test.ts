...
describe('agent-driven brand extraction engine', () => {
  ...
  it('prefers source-backed human brand tokens over script/debug color noise', () => {
    const brand = brandFromMaterial({
      ...
      siteName: 'Semurai Creative',
      title: 'Semurai Creative',
      description: 'Semurai Creative design system.',
      colors: [
      ...
      fontFiles: [],
      logos: [],
      headings: ['Semurai Creative The Open-source Claude Design alternative'],
      paragraphs: ['Semurai Creative is a local-first design platform.'],
      navLabels: [],
      extraPages: [],
      screenshot: null,
      thin: false,
