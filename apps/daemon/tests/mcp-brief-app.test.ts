...
describe('local Semurai Creative MCP brief app', () => {
  ...
  it('keeps user-facing MCP copy on public Semurai Creative product terms', () => {
    ...
    expect(userFacingCopy).toContain('Semurai Creative Cloud');
