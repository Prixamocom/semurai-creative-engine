...
const VALID_BRAND = {
  name: 'Semurai Creative',
  tagline: 'The open-source, local-first alternative to Claude Design.',
  description:
    'Semurai Creative is the official open-source, local-first alternative to Claude Design — an agent-native design platform that turns the coding agent into a full design studio, generating on-brand artifacts from a single source of truth.',
  colors: [
