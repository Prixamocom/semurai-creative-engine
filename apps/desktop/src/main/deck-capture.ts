import { runDomToPptx, cjkPromotedFontFamily, type LayeredPptxBackgroundCapture } from "@open-design/artifact-renderer";
export { runDomToPptx, cjkPromotedFontFamily, type LayeredPptxBackgroundCapture } from "@open-design/artifact-renderer";
