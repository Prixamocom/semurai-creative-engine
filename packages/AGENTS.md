...
- `packages/artifact-renderer`: browser-only DOM normalization for editable artifact export, shared by web and desktop. No host, Node, daemon, or project ownership APIs belong here.
