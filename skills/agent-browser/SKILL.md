...
description: |
  ...
  Semurai Creative browser-tab context, testing web apps, dogfooding Semurai Creative
  previews, QA, bug hunts, or reviewing app quality. Prefer local Semurai Creative
...
Use `agent-browser` for local Semurai Creative preview validation: inspect rendered
...
For selected Semurai Creative browser tabs and browser-use/browser-harness-style
...
5. If the selected Semurai Creative context only provided a URL/title and no browser
...
Do not run Semurai Creative's own daemon CLI as a browser automation tool. Commands
...
With the Semurai Creative preview at `http://127.0.0.1:17573/`, run:
...
Expected success: title `Semurai Creative`, current URL under `127.0.0.1:17573`,
visible Semurai Creative UI text in the snapshot, and a screenshot at
