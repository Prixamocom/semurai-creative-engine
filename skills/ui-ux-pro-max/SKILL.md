...
name: ui-ux-pro-max
description: |
  Catalog-only UI/UX Pro Max entry. The full upstream templates, data, and search workflow are not bundled in Semurai Creative.
triggers:
  - "ui ux patterns"
  - "design patterns"
  - "ux heuristics"
...
## Current Semurai Creative scope

Semurai Creative currently ships this entry as discovery metadata only. If this `SKILL.md`
...
This catalogue entry advertises the skill in Semurai Creative so the agent
...
If those upstream files are not installed, explain that Semurai Creative only has the
catalog entry for this skill and ask whether to continue with Semurai Creative's
