...
Agent-facing guidance for the Semurai Creative curated integration of Cloudflare Kumo UI.
...
- Use Kumo's native `data-mode="dark"` hook; `data-theme="dark"` is included only for Semurai Creative artifact compatibility.
- Treat the section, container, and extended heading tokens as Semurai Creative compatibility bindings, not upstream Kumo tokens.
